export default function BottomBanner({ text, icon, afterContent }) {
  return (
    <div className='relative h-full w-full flex justify-center'>
      <div className='absolute inset-x-0 bottom-10 md:bottom-2 flex justify-center'>
        <div className='bg-black bg-opacity-50 flex justify-center p-2 md:p-4 items-center gap-2'>
